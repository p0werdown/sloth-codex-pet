...
source_dir="$script_dir/lanlan"
codex_root=${CODEX_HOME:-"$HOME/.codex"}
pets_dir="$codex_root/pets"
target_dir="$pets_dir/lanlan"
...
if [ ! -f "$source_dir/pet.json" ] || [ ! -f "$source_dir/spritesheet.png" ]; then
  printf '%s\n' "安装包不完整：找不到 lanlan/pet.json 或 lanlan/spritesheet.png。" >&2
  exit 1
fi

verify_sha256 "cd04aa9d97274fbbcb82294c5a5860f46453899d21a5046806d208eef657c0ba" "$source_dir/pet.json"
